...
- Added grouped Ledger hover highlighting for customer, project, period, and task cells.
...
- Changed KSOE and KATECH sample client names to short labels and normalize matching saved client names on load.
